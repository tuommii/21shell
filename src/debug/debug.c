...
/*   Updated: 2020/02/13 16:05:47 by srouhe           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_printf("\033[s");
	ft_printf("\033[1;1f %10s: [%3d]\033[u", "CURSOR X", g_sh.x);
	ft_printf("\033[2;1f %10s: [%3d]\033[u", "INDEX", g_sh.i);
	ft_printf("\033[3;1f %10s: [%3d]\033[u", "KEY", g_sh.key);
	ft_printf("\033[4;1f %10s: [%3d]\033[u", "LEN", g_sh.len);
	ft_printf("\033[5;1f %10s: [%-70s]\033[u", "INPUT", g_sh.input);
	// t_hist *hist = g_sh.hist
	ft_printf("\033[6;1f %10s: [%3d, %3d]\033[u", "HIST", g_sh.hist_i, g_sh.hist_count);
	ft_printf("\033[u");
}
